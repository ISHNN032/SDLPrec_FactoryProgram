...
TouchActivity::TouchActivity(int a)
{
    window = NULL;
    screen = NULL;
    quitting = SDL_FALSE;
...
SDL_Window *TouchActivity::initWindow(SDL_Window *window, int width, int height)
{
    if (!window)
    {
...
void TouchActivity::setpix(SDL_Surface *screen, float _x, float _y, unsigned int col)
{
    Uint32 *pixmem32;
    Uint32 colour;
    Uint8 r, g, b;
...
void TouchActivity::drawLine(SDL_Surface *screen, float x0, float y0, float x1, float y1, unsigned int col)
{
    float t;
...
void TouchActivity::drawCircle(SDL_Surface *screen, float x, float y, float r, unsigned int c)
{
    float tx, ty;
    float xr;
...
void TouchActivity::drawKnob(SDL_Surface *screen, Knob k)
{
...
void TouchActivity::DrawScreen(SDL_Surface *screen, SDL_Window *window)
{
    int i;
#if 1
